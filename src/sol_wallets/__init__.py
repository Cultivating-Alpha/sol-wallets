...
# # Create the main wallet and 25 sub-wallets

# # Save the wallets to a file for future use
# with open("wallets.json", "w") as f:
#     wallets = {
#         "main_wallet": list(main_wallet.secret_key),
#         "sub_wallets": [list(sw.secret_key) for sw in sub_wallets],
#     }
#     json.dump(wallets, f, indent=4)

# print(f"Main wallet public key: {main_wallet.public_key}")
